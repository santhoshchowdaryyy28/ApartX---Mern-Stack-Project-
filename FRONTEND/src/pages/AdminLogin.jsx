      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .apt-photo {
          position: absolute;
          inset: 0;
          background-image: url('https://images.unsplash.com/photo-1486325212027-8081e485255e?w=1400&q=85&auto=format&fit=crop');
        ...
        .apt-glow {
          position: absolute;
          inset: 0;
          background: radial-gradient(ellipse at 25% 85%, rgba(220,60,60,0.22) 0%, transparent 55%);
        }
        ...
        .left-tag-dot { width:6px;height:6px;border-radius:50%;background:#f87171;animation:blink 2s infinite; }
        ...
        .left-title em { font-style: italic; color: #fca5a5; }
        ...
        .login-right::after {
          ...
          background: radial-gradient(circle at bottom right,rgba(220,38,38,0.1),transparent 70%);
          pointer-events:none;
        }

        .form-eyebrow {
          font-size: 11px; letter-spacing: 3px; text-transform: uppercase;
          color: rgba(248,113,113,0.7); margin-bottom: 12px;
        ...
        .login-btn:hover { opacity:0.92; transform:translateY(-1px); box-shadow:0 8px 32px rgba(220,38,38,0.45); }
        ...
        .form-footer a { color:#f87171; cursor:pointer; text-decoration:none; font-weight:500; }
        .form-footer a:hover { color:#fca5a5; }
      ...
      <div className="login-root">
        ...
        <div className="login-left">
          ...
          <div className="photo-topbar">
            <div className="photo-logo">
              <div className="photo-logo-box">🛡️</div>
              ApartX
            </div>
            <div className="live-badge">
              <div className="live-dot" /> Admin Portal
            </div>
          </div>

          <div className="left-content">
            <div className="left-tag">
              <div className="left-tag-dot" /> Admin Access
            </div>
            <h1 className="left-title">
              Manage<br /><em>Your</em><br />Community
            </h1>
            <p className="left-desc">
              Full control over billing, complaints, notices, and resident management — all in one place.
            </p>
            <div className="stats-bar">
              <div className="stat-box">
                <div className="stat-num">100%</div>
                <div className="stat-lbl">Control</div>
              </div>
              <div className="stat-box">
              ...
              <div className="stat-box">
                ...
                <div className="stat-lbl">Access</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="login-right">
          ...
          <p className="form-footer">
            Resident?{" "}
            <a onClick={() => (window.location.href = "/")}>Go to resident login</a>
          </p>
        </div>
